 ...
 * @since 2016-08-16T15:16:00
 */
public class VideoStageDemo {
    private static int TIMEOUT = 5000;
    private static final Logger log = LoggerFactory.getLogger(VideoStageDemo.class);
